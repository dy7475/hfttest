...
<meta charset="UTF-8">
<title>购买软件</title>
<link href="${statics}ucenter/softPay/css/index.css" rel="stylesheet" />
</head>
		...
		<div class="container">
			...
			<div class="con-left l">
				...
				<div id="payInfoBox">
					...
					<div class="pay-text price">0元</div>
				</div>
...
<script src="${statics}ucenter/softPay/js/softPay.js" type="text/javascript"></script>
</html>
