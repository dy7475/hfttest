...
<div class="supporting" id="supporting" >
	<div id="searchTitleBox">
		<ul>
			<li class="liChecked" style="line-height: 33px;cursor:default;" onclick="searchAround(this);">交通</li>
			<li onclick="searchAround(this);">教育</li>
			<li onclick="searchAround(this);">医疗</li>
			<li onclick="searchAround(this);">购物</li>
			<li onclick="searchAround(this);">生活</li>
			<li onclick="searchAround(this);">娱乐</li>
		</ul>
	</div>
...
<script type="text/javascript">
    ...
    function addBuildMark() {
        var buildIcon = new BMap.Icon("${statics}/images/circle.png", new BMap.Size(16, 16));
