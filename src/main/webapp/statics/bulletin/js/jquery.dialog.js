...
;(function($){
	...
	loadStyle = function(doc) {
		...
		if(!link){
//	        link = createEl('link',doc);
//	        link.setAttribute('type', 'text/css');
//	        link.setAttribute('rel', 'stylesheet');
//	        link.setAttribute('id', '_DIALOG_CSS');
//	        link.setAttribute('href', scriptPath + "jquery.dialog.css");
		...
		if(divObj==null){
			...
			if(closeEnable){
				$("#closeAlert_btn, #closeDialog_btn"+id).click(function(){
					document.body.removeChild(divObj);return false;
				});
			}else{
