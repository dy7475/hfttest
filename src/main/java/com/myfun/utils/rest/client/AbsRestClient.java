...
import com.myfun.utils.rest.SSLHttpClient;
import com.myfun.utils.rest.SysConfig;
...
public abstract class AbsRestClient {
	 ...
	 * callback
	 */
	public abstract String callback(String accountSid, String authToken,String appId,String fromClient,String to,String fromSerNum,String toSerNum,String userData);
	/**
	 * 
	 * @param accountSid
	 * @param authToken
