 ...
 * @project rest_demo
 */
package com.myfun.utils.rest.client;
...
import com.myfun.utils.rest.models.AppBill;
import com.myfun.utils.rest.models.Callback;
import com.myfun.utils.rest.models.ClientBill;
import com.myfun.utils.rest.models.TemplateSMS;
import com.myfun.utils.rest.models.VoiceCode;
public class JsonReqClient extends AbsRestClient {
	...
	public String callback(String accountSid, String authToken, String appId,
			String fromClient, String to,String fromSerNum,String toSerNum,String userData) {
		// TODO Auto-generated method stub
		String result = "";
		DefaultHttpClient httpclient=getDefaultHttpClient();
		try {
