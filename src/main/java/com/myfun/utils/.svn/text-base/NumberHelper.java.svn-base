...
public final class NumberHelper {
	...
	/**
	 * 采用科学计数法表示一个数，整数部分（整数大于等于0小于10）有一位，若整数部分为0，显示为0， 小数部分有0位，指数显示为整数
	 */
	...
	/**
	 * 将给定的一个数字按中国的习惯和按始终显示两位小数，整数部分超过3位时不用","分开的格式格式化 并返回一个该格式化后的字符串
	 * 
	 * @param number
	 *            被格式化的数字
	 * @return 返回格式化后的数字的对应的字符串
	...
	/**
	 * 将给定的一个数字字符串按中国的习惯和按始终显示两位小数，整数部分超过3位时不用","分开的格式格式化 并返回一个该格式化后的字符串
	 * 
	 * @param number
	 *            被格式化的数字对应的字符串
	 * @return 返回格式化后的数字的对应的字符串
	...
	/**
	 * 将给定的一个数字按指定的国家的风格和按始终显示两位小数，整数部分超过3位时不用","分开的格式格式化 并返回一个该格式化后的字符串
	 * 
	 * @param number
	 *            被格式化的数字
	 * @return 返回格式化后的数字的对应的字符串
	...
	/**
	 * 将给定的一个数字字符串按指定的国家的风格和按始终显示两位小数，整数部分超过3位时不用","分开的格式格式化 并返回一个该格式化后的字符串
	 * 
	 * @param number
	 *            被格式化的数字对应的字符串
	 * @return 返回格式化后的数字的对应的字符串
	...
	/**
	 * 将给定的一个数字按默认操作系统所在的国家的习惯和按始终显示两位小数，整数部分超过3位时不用","分开的格式格式化 并返回一个该格式化后的字符串
	 * 
	 * @param number
	 *            被格式化的数字
	 * @return 返回格式化后的数字的对应的字符串
	 ...
	 *            已经格式化后的数字串
	 * @return 返回格式化后的对应的double值，如3,345.12 返回3345.12
	 */
	public static double unFormatCommaNumber(String formatedNumber) {

		String[] numbers = StringUtil.split(formatedNumber, ",");
	...
	/**
	 * 返回一个数字串的口读时的小写中文值读法对应的中文字符串，如
	 * <p>
	 * 32返回三十二,2022211102返回：二十亿二千二百二十一万一千一百零二
	 * 
	 * @param num
	 *            要处理的数字串，所代表的数字只能为java int 型范围（10位长度）
	 * @return 返回一个数字串的口读时的小写中文值读法对应的中文字符串,
	 *         <p>
	...
	protected static String getReadCNStringOfNumber(String num) {
		...
		case 6:
			...
			if (num.substring(1, 2).equals("0") && num.substring(2, 3).equals("0") && num.substring(3, 4).equals("0")
					&& num.substring(4, 5).equals("0") && num.substring(5, 6).equals("0")) {
				reStr += "万";
				break;
			} else if (!num.substring(1, 2).equals("0")) {
	...
	/**
	 * 返回一个数字串的金钱书写时的大写中文值写法对应的中文字符串，以满足中国写金钱的习愦,
	 * <p>
	 * 如32:返回叁拾贰,256返回：贰佰伍拾陆,2005返回：贰仟零佰零拾伍,54005返回：伍万肆仟零佰零拾伍
	 * 
	 * @param num
	 *            要处理的数字串，所代表的数字只能为java int 型范围（10位长度）
	 * @return 返回一个数字串的金钱书写时的大写中文值写法对应的中文字符串，以满足中国写金钱的习愦,
	 *         <p>
	 *         如32:返回叁拾贰,256返回:贰佰伍拾陆,2005返回：贰仟零佰零拾伍,54005返回：伍万肆仟零佰零拾伍
	 * 
	 * @deprecated 此方法还有待完善
	...
	/**
	 * 将给定的一个数字格式化成为中国风格的金钱大写格式;如11.26返回：壹拾壹圆贰角陆分整；3005,返回：三仟零佰零拾伍圆整，3005.00返回：
	 * 三仟零佰零拾伍圆零角零分整
	 * 
	 * @param num
	 *            被格式化的数字
	 * @return 返回被格式化后的字符串;如11.26返回：壹拾壹圆贰角陆分整；3005,返回：三仟零佰零拾伍圆整，3005.00返回：
	 *         三仟零佰零拾伍圆零角零分整
	 * 
	 * @deprecated 此方法还有待完善
	 */
	...
	/**
	 * 将给定的一个数字字符串格式化成为中国风格的金钱大写格式,如：11.26返回：壹拾壹圆贰角陆分整；3005,返回：三仟零佰零拾伍圆整，3005.
	 * 00返回：三仟零佰零拾伍圆零角零分整
	 * 
	 * @param numStr
	 *            被格式化的数字
	 * @return 返回被格式化后的字符串，如：11.26返回：壹拾壹圆贰角陆分整；3005,返回：三仟零佰零拾伍圆整，3005.00返回：
	 *         三仟零佰零拾伍圆零角零分整
	 * 
	 * @deprecated 此方法还有待完善
	 */
