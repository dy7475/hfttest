...
import com.myfun.repository.reportdb.po.ReportFunLeaseMin;
import com.myfun.repository.reportdb.po.ReportFunLeaseMinExample;
import com.myfun.repository.support.annotation.SwitchDB;
import com.myfun.repository.support.datasource.SwitchDBType;
import com.myfun.repository.support.mybatis.api.BaseMapper;

public interface ReportFunLeaseMinMapper extends BaseMapper<ReportFunLeaseMin, Long> {
    /**
	 * @mbggenerated
	 */
	int countByExample(ReportFunLeaseMinExample example);

	/**
	 * @mbggenerated
	 */
	int deleteByExample(ReportFunLeaseMinExample example);

	/**
	 * @mbggenerated
	 */
	List<ReportFunLeaseMin> selectByExample(ReportFunLeaseMinExample example);

	/**
	 * @mbggenerated
	 */
	int updateByExampleSelective(@Param("record") ReportFunLeaseMin record,
			@Param("example") ReportFunLeaseMinExample example);

	/**
	 * @mbggenerated
	 */
	int updateByExample(@Param("record") ReportFunLeaseMin record, @Param("example") ReportFunLeaseMinExample example);
	...
	List<Map<String,Object>> getCompLeaseCountByDate(@Param("param")AnalysisForWebParam param);
}