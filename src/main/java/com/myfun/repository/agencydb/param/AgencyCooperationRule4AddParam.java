...
public class AgencyCooperationRule4AddParam implements Serializable {
    /**
     *
    ...
    public void setSoleSpecial(String soleSpecial) {
        this.soleSpecial = soleSpecial == null ? null : soleSpecial.trim();
    }
    ...
    public void setGroupSpecial(String groupSpecial) {
        this.groupSpecial = groupSpecial == null ? null : groupSpecial.trim();
    }
    ...
    public void setBandSaw(String bandSaw) {
        this.bandSaw = bandSaw == null ? null : bandSaw.trim();
    }
    ...
    public void setCooperateStart(String cooperateStart) {
        this.cooperateStart = cooperateStart == null ? null : cooperateStart.trim();
    }
    ...
    public void setCooperateEnd(String cooperateEnd) {
        this.cooperateEnd = cooperateEnd == null ? null : cooperateEnd.trim();
    }
