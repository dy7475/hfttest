...
public class AgencyBuildingInfoTmp extends AgencyBuildingInfoTmpKey implements Serializable {
    /**
     *
     * @mbggenerated
     */
     ...
     * @mbggenerated
     */
    public void setExamFlag(Byte examFlag) {
     ...
     * @mbggenerated
     */
    public void setCreatorUid(Short creatorUid) {
