...
public class AgencyVipRent1 extends AgencyVipRent1Key {
    /**
     *
     * @mbggenerated
     */
    ...
    public void setRentSubject(String rentSubject) {
        this.rentSubject = rentSubject == null ? null : rentSubject.trim();
    }
     ...
     * @mbggenerated
     */
    public void setWfOnlineMoney(Long wfOnlineMoney) {
     ...
     * @mbggenerated
     */
    public void setWfMoneyPay(Long wfMoneyPay) {
