...
public class AgencyVipRent implements Serializable {
	...
	/**
	 * @mbggenerated 佣金比例(0为10天佣, 0.5为15天佣, 1为20天佣)
	 */
	...
	/**
	 * @mbggenerated 返回给用户的钱
	 */
	private Long wfMoneyReturn;
	/**
	 * @mbggenerated 线上设置的支付金额
	 */
