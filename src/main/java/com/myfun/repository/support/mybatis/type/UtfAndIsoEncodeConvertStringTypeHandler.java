 ...
 * 
 * @ClassName: UtfAndIsoEncodeConvertStringTypeHandler
 * @Description: TODO
 * @author jiangsonggui
 * @date 2015年11月18日 下午5:43:21
 *
 */
@MappedJdbcTypes(value = { JdbcType.VARCHAR, JdbcType.CLOB, JdbcType.NVARCHAR, JdbcType.LONGVARCHAR, JdbcType.CHAR })
public class UtfAndIsoEncodeConvertStringTypeHandler extends StringTypeHandler {
