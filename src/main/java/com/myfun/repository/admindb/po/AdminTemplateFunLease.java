...
public class AdminTemplateFunLease implements Serializable {
    /**
     *
     * @mbggenerated
     */
     ...
     * @mbggenerated
     */
    public void setLeaseDoors(Byte leaseDoors) {
     ...
     * @mbggenerated
     */
    public void setLeaseFloors(Byte leaseFloors) {
     ...
     * @mbggenerated
     */
    public void setLeaseConsign(Byte leaseConsign) {
     ...
     * @mbggenerated
     */
    public void setLeaseMap(Byte leaseMap) {
