...
public class AdminTemplateFunRentCustomer implements Serializable {
    /**
     *
     * @mbggenerated
     */
    ...
    public void setRentCustName(String rentCustName) {
        this.rentCustName = rentCustName == null ? null : rentCustName.trim();
    }
    ...
    public void setRentLifebound(String rentLifebound) {
        this.rentLifebound = rentLifebound == null ? null : rentLifebound.trim();
    }
