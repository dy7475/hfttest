...
public class ErpFunStreetProvince extends ShardDb implements Serializable {
    /**
     *
     * @mbggenerated
     */
     ...
     * @mbggenerated
     */
    public ErpFunStreetProvince(Integer shardCityId, Integer id) {
        super(shardCityId);
        this.id = id;
    }
}