...
public class ErpFunBuyCustomerTemplate extends ShardDb {
    /**
     *
     * @mbggenerated
     */
    ...
    public void setBuyCustNo(String buyCustNo) {
        this.buyCustNo = buyCustNo == null ? null : buyCustNo.trim();
    }
     ...
     * @mbggenerated
     */
    public ErpFunBuyCustomerTemplate() {
     ...
     * @mbggenerated
     */
    public ErpFunBuyCustomerTemplate(Integer shardCityId) {
        super(shardCityId);
    }
}