...
public class ErpBuildingPhotoFastdfs extends ShardDb implements Serializable {
    /**
     *
     * @mbggenerated
     */
     ...
     * @mbggenerated
     */
    public ErpBuildingPhotoFastdfs() {
     ...
     * @mbggenerated
     */
    public ErpBuildingPhotoFastdfs(Integer shardCityId, Integer photoId) {
        super(shardCityId);
        this.photoId = photoId;
    }
}