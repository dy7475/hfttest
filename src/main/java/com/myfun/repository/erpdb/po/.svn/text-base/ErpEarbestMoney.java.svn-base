...
public class ErpEarbestMoney extends ShardDb implements Serializable {
	 ...
	 * @mbggenerated
	 */
	public ErpEarbestMoney() {
	}

	/**
	 * @mbggenerated
	 */
	public ErpEarbestMoney(Integer shardCityId, Integer earbestId) {
		super(shardCityId);
		this.earbestId = earbestId;
	}
}