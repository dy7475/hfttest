...
public class ErpFunWorkcountTarget extends ShardDb implements Serializable {
	 ...
	 * @mbggenerated
	 */
	public ErpFunWorkcountTarget() {
	}

	/**
	 * @mbggenerated
	 */
	public ErpFunWorkcountTarget(Integer shardCityId, Integer id) {
		super(shardCityId);
		this.id = id;
	}
}