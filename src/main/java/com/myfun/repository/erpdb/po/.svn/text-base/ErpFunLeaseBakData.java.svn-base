...
public class ErpFunLeaseBakData extends ShardDb implements Serializable {
    /**
     *
     * @mbggenerated
     */
     ...
     * @mbggenerated
     */
    public ErpFunLeaseBakData(Integer shardCityId, Integer leaseId) {
        super(shardCityId);
        this.leaseId = leaseId;
    }
}