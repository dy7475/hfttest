...
public class ErpFunStreetSection extends ShardDb implements Serializable {
	 ...
	 * @mbggenerated
	 */
	public ErpFunStreetSection() {
	}

	/**
	 * @mbggenerated
	 */
	public ErpFunStreetSection(Integer shardCityId, Integer id) {
		super(shardCityId);
		this.id = id;
	}
}