...
public class ErpFunTrackBak extends ShardDb {
    /**
     *
     * @mbggenerated
     */
    ...
    public void setTrackClassic(String trackClassic) {
        this.trackClassic = trackClassic == null ? null : trackClassic.trim();
    }
     ...
     * @mbggenerated
     */
    public ErpFunTrackBak(Integer shardCityId) {
        super(shardCityId);
    }
}