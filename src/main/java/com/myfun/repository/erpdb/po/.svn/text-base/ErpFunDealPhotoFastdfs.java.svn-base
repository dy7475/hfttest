...
public class ErpFunDealPhotoFastdfs extends ShardDb implements Serializable {
    /**
     *
     * @mbggenerated
     */
     ...
     * @mbggenerated
     */
    public ErpFunDealPhotoFastdfs(Integer shardCityId, Integer photoId) {
        super(shardCityId);
        this.photoId = photoId;
    }
}