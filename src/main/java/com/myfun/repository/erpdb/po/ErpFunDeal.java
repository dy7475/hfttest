...
public class ErpFunDeal extends ShardDb implements Serializable {
	 ...
	 * @mbggenerated
	 */
	@ApiModelProperty(value = "成交类型，DD:CASE_TYPE  出售： 101   出租 102")
	private Byte dealType;
	/**
	 * @mbggenerated
	 */
	@ApiModelProperty(value = "0,1,2未分配，1=待结算，2=已结算 3=结算中 4=撤销结算中")
	private Byte dealStatus;
	/**
	 * @mbggenerated
	 */
	@ApiModelProperty(value = "主办人(USER_ID) 流程总负责人")
	 ...
	 * @mbggenerated
	 */
	@ApiModelProperty(value = "合同审核状态 0=未审核，1=初审，2=复审，3=作废 4=未作废 5=初审中  6=复审中  7=作废中 8=撤销初审中 9=撤销复审中")
	private Byte dealAuditStatus;
	/**
	 * @mbggenerated
	 */
	@ApiModelProperty(value = "商业贷放款日期")
	private Date commercialLoanDate;
	/**
	 * @mbggenerated
	 */
	@ApiModelProperty(value = "商业贷贷款日期")
	private Date commercialLenderDate;
	/**
	 * @mbggenerated
	 */
	 ...
	 * @mbggenerated
	 */
	@ApiModelProperty(value = "签约人档案id")
	 ...
	 * @mbggenerated
	 */
	@ApiModelProperty(value = "卖方微信user_id")
	private String sellOwnerWxUserId;
	/**
	 * @mbggenerated
	 */
	@ApiModelProperty(value = "卖方微信open_id")
	private String sellOwnerWxOpenId;
	/**
	 * @mbggenerated
	 */
	@ApiModelProperty(value = "买方微信user_id")
	private String buyOwnerWxUserId;
	/**
	 * @mbggenerated
	 */
	@ApiModelProperty(value = "买方微信open_id")
	private String buyOwnerWxOpenId;
	/**
	 * @mbggenerated
	 */
	@ApiModelProperty(value = "签约类型 0=线下 1=线上")
	...
	/**
	 * @mbggenerated 成交类型，DD:CASE_TYPE  出售： 101   出租 102
	 */
	...
	/**
	 * @mbggenerated 0,1,2未分配，1=待结算，2=已结算 3=结算中 4=撤销结算中
	 */
	...
	/**
	 * @mbggenerated 主办人(USER_ID) 流程总负责人
	 */
	...
	public void setDealCustomerNo(String dealCustomerNo) {
		this.dealCustomerNo = dealCustomerNo;
	}
	...
	public void setSellHezuoCompname(String sellHezuoCompname) {
		this.sellHezuoCompname = sellHezuoCompname;
	}
	...
	public void setBuyHezuoCompname(String buyHezuoCompname) {
		this.buyHezuoCompname = buyHezuoCompname;
	}
	...
	public void setBuyContactuser(String buyContactuser) {
		this.buyContactuser = buyContactuser;
	}
	...
	public void setSellContactuser(String sellContactuser) {
		this.sellContactuser = sellContactuser;
	}
	...
	public void setBuyCallPhone(String buyCallPhone) {
		this.buyCallPhone = buyCallPhone;
	}
	...
	public void setSellCallPhone(String sellCallPhone) {
		this.sellCallPhone = sellCallPhone;
	}
	...
	public void setTradeRemarkExplain(String tradeRemarkExplain) {
		this.tradeRemarkExplain = tradeRemarkExplain;
	}
	...
	public void setRentPaySpace(String rentPaySpace) {
		this.rentPaySpace = rentPaySpace;
	}
	...
	public void setRentPayEarly(String rentPayEarly) {
		this.rentPayEarly = rentPayEarly;
	}
	...
	public void setGoodsdetailed(String goodsdetailed) {
		this.goodsdetailed = goodsdetailed;
	}
	...
	public void setWaterlightexpenses(String waterlightexpenses) {
		this.waterlightexpenses = waterlightexpenses;
	}
	...
	public void setHouseDeptname(String houseDeptname) {
		this.houseDeptname = houseDeptname;
	}
	...
	public void setSignUserDeptName(String signUserDeptName) {
		this.signUserDeptName = signUserDeptName;
	}
	...
	public void setSignManagerDeptName(String signManagerDeptName) {
		this.signManagerDeptName = signManagerDeptName;
	}
	...
	public void setBuyOwnerNameBak(String buyOwnerNameBak) {
		this.buyOwnerNameBak = buyOwnerNameBak;
	}
	...
	public void setSellOwnerNameBak(String sellOwnerNameBak) {
		this.sellOwnerNameBak = sellOwnerNameBak;
	}
	...
	public void setBuyIdCardBak(String buyIdCardBak) {
		this.buyIdCardBak = buyIdCardBak;
	}
	...
	public void setSellIdCardBak(String sellIdCardBak) {
		this.sellIdCardBak = sellIdCardBak;
	}
	...
	public void setBuyCustomerPhoneencode(String buyCustomerPhoneencode) {
		this.buyCustomerPhoneencode = buyCustomerPhoneencode;
	}
	...
	public void setSellOwnerPhone(String sellOwnerPhone) {
		this.sellOwnerPhone = sellOwnerPhone;
	}
	...
	public void setSellOwnerPhoneencode(String sellOwnerPhoneencode) {
		this.sellOwnerPhoneencode = sellOwnerPhoneencode;
	}
	...
	public void setSellOwnerPhoneBak(String sellOwnerPhoneBak) {
		this.sellOwnerPhoneBak = sellOwnerPhoneBak;
	}
	...
	public void setBuyCustomerPhoneBak(String buyCustomerPhoneBak) {
		this.buyCustomerPhoneBak = buyCustomerPhoneBak;
	}
	...
	/**
	 * @mbggenerated 合同审核状态 0=未审核，1=初审，2=复审，3=作废 4=未作废 5=初审中  6=复审中  7=作废中 8=撤销初审中 9=撤销复审中
	 */
	...
	/**
	 * @mbggenerated 商业贷放款日期
	 */
	public Date getCommercialLoanDate() {
	 ...
	 * @mbggenerated 商业贷放款日期
	 */
	public void setCommercialLoanDate(Date commercialLoanDate) {
		this.commercialLoanDate = commercialLoanDate;
	}

	/**
	 * @mbggenerated 商业贷贷款日期
	 */
	public Date getCommercialLenderDate() {
	 ...
	 * @mbggenerated 商业贷贷款日期
	 */
	public void setCommercialLenderDate(Date commercialLenderDate) {
	...
	public void setCommercialLenderLimit(String commercialLenderLimit) {
		this.commercialLenderLimit = commercialLenderLimit;
	}
	...
	public void setCommercialLenderBank(String commercialLenderBank) {
		this.commercialLenderBank = commercialLenderBank;
	}
	...
	public void setProvidentLenderLimit(String providentLenderLimit) {
		this.providentLenderLimit = providentLenderLimit;
	}
	...
	public void setProvidentLenderBank(String providentLenderBank) {
		this.providentLenderBank = providentLenderBank;
	}
	...
	public void setTaxesAuditName(String taxesAuditName) {
		this.taxesAuditName = taxesAuditName;
	}
	...
	public void setYouAduitOpinion(String youAduitOpinion) {
		this.youAduitOpinion = youAduitOpinion;
	}
	...
	public void setBuildRegName(String buildRegName) {
		this.buildRegName = buildRegName;
	}
	...
	public void setSellerProxyName(String sellerProxyName) {
		this.sellerProxyName = sellerProxyName;
	}
	...
	public void setSellerProxyIdcard(String sellerProxyIdcard) {
		this.sellerProxyIdcard = sellerProxyIdcard;
	}
	...
	public void setSellerProxyPhone(String sellerProxyPhone) {
		this.sellerProxyPhone = sellerProxyPhone;
	}
	...
	public void setSellerProxyPhoneencode(String sellerProxyPhoneencode) {
		this.sellerProxyPhoneencode = sellerProxyPhoneencode;
	}
	...
	public void setBuyerProxyName(String buyerProxyName) {
		this.buyerProxyName = buyerProxyName;
	}
	...
	public void setBuyerProxyIdcard(String buyerProxyIdcard) {
		this.buyerProxyIdcard = buyerProxyIdcard;
	}
	...
	public void setBuyerProxyPhone(String buyerProxyPhone) {
		this.buyerProxyPhone = buyerProxyPhone;
	}
	...
	public void setBuyerProxyPhoneencode(String buyerProxyPhoneencode) {
		this.buyerProxyPhoneencode = buyerProxyPhoneencode;
	}
	...
	public void setSellerTaxFee(String sellerTaxFee) {
		this.sellerTaxFee = sellerTaxFee;
	}
	...
	public void setDepositPayOther(String depositPayOther) {
		this.depositPayOther = depositPayOther;
	}
	...
	public void setDownPaymentsPayTime1(String downPaymentsPayTime1) {
		this.downPaymentsPayTime1 = downPaymentsPayTime1;
	}
	...
	public void setHousePriceLastPayTime1(String housePriceLastPayTime1) {
		this.housePriceLastPayTime1 = housePriceLastPayTime1;
	}
	...
	public void setApplicationRepaymentOther(String applicationRepaymentOther) {
		this.applicationRepaymentOther = applicationRepaymentOther;
	}
	...
	public void setOwnershipObligatiionNumber(String ownershipObligatiionNumber) {
		this.ownershipObligatiionNumber = ownershipObligatiionNumber;
	}
	...
	public void setSellerBankType(String sellerBankType) {
		this.sellerBankType = sellerBankType;
	}
	...
	public void setSellerBankUserName(String sellerBankUserName) {
		this.sellerBankUserName = sellerBankUserName;
	}
	...
	public void setBuyerBankType(String buyerBankType) {
		this.buyerBankType = buyerBankType;
	}
	...
	public void setBuyerBankUserName(String buyerBankUserName) {
		this.buyerBankUserName = buyerBankUserName;
	}
	...
	public void setDownPaymentsPayTime2(String downPaymentsPayTime2) {
		this.downPaymentsPayTime2 = downPaymentsPayTime2;
	}
	...
	public void setDownPaymentsPayTime3(String downPaymentsPayTime3) {
		this.downPaymentsPayTime3 = downPaymentsPayTime3;
	}
	...
	public void setHousePriceLastPayTime2(String housePriceLastPayTime2) {
		this.housePriceLastPayTime2 = housePriceLastPayTime2;
	}
	...
	public void setHousePriceLastPayTime3(String housePriceLastPayTime3) {
		this.housePriceLastPayTime3 = housePriceLastPayTime3;
	}
	...
	public void setWaterLeakagePosition(String waterLeakagePosition) {
		this.waterLeakagePosition = waterLeakagePosition;
	}
	...
	public void setHousePeelingPosition(String housePeelingPosition) {
		this.housePeelingPosition = housePeelingPosition;
	}
	...
	public void setSubmitLoanInfoFeeDays(String submitLoanInfoFeeDays) {
		this.submitLoanInfoFeeDays = submitLoanInfoFeeDays;
	}
	...
	public void setDownPaymentsPayBank(String downPaymentsPayBank) {
		this.downPaymentsPayBank = downPaymentsPayBank;
	}
	...
	public void setDownPaymentsPayAccountName(String downPaymentsPayAccountName) {
		this.downPaymentsPayAccountName = downPaymentsPayAccountName;
	}
	...
	public void setDownPaymentsPayAccountNo(String downPaymentsPayAccountNo) {
		this.downPaymentsPayAccountNo = downPaymentsPayAccountNo;
	}
	...
	public void setDownPaymentsThirdParty(String downPaymentsThirdParty) {
		this.downPaymentsThirdParty = downPaymentsThirdParty;
	}
	...
	public void setDownPaymentsRemainingFirstPaytime(String downPaymentsRemainingFirstPaytime) {
		this.downPaymentsRemainingFirstPaytime = downPaymentsRemainingFirstPaytime;
	}
	...
	public void setDownPaymentsRemainingFirstAmount(String downPaymentsRemainingFirstAmount) {
		this.downPaymentsRemainingFirstAmount = downPaymentsRemainingFirstAmount;
	}
	...
	public void setHousePriceLastPayAmount3(String housePriceLastPayAmount3) {
		this.housePriceLastPayAmount3 = housePriceLastPayAmount3;
	}
	...
	public void setHousePriceLastPayAmount2(String housePriceLastPayAmount2) {
		this.housePriceLastPayAmount2 = housePriceLastPayAmount2;
	}
	...
	public void setDownPaymentsPayAmount3(String downPaymentsPayAmount3) {
		this.downPaymentsPayAmount3 = downPaymentsPayAmount3;
	}
	...
	public void setDownPaymentsPayAmount2(String downPaymentsPayAmount2) {
		this.downPaymentsPayAmount2 = downPaymentsPayAmount2;
	}
	...
	public void setNoPassSloutionAmount(String noPassSloutionAmount) {
		this.noPassSloutionAmount = noPassSloutionAmount;
	}
	...
	public void setHousePriceLastPayAmount1(String housePriceLastPayAmount1) {
		this.housePriceLastPayAmount1 = housePriceLastPayAmount1;
	}
	...
	public void setDownPaymentsPayAmount1(String downPaymentsPayAmount1) {
		this.downPaymentsPayAmount1 = downPaymentsPayAmount1;
	}
	...
	public void setHousePriceLastAmount(String housePriceLastAmount) {
		this.housePriceLastAmount = housePriceLastAmount;
	}
	...
	/**
	 * @mbggenerated 卖方微信user_id
	 */
	public String getSellOwnerWxUserId() {
		return sellOwnerWxUserId;
	}

	/**
	 * @mbggenerated 卖方微信user_id
	 */
	public void setSellOwnerWxUserId(String sellOwnerWxUserId) {
		this.sellOwnerWxUserId = sellOwnerWxUserId;
	}

	/**
	 * @mbggenerated 卖方微信open_id
	 */
	public String getSellOwnerWxOpenId() {
		return sellOwnerWxOpenId;
	}

	/**
	 * @mbggenerated 卖方微信open_id
	 */
	public void setSellOwnerWxOpenId(String sellOwnerWxOpenId) {
		this.sellOwnerWxOpenId = sellOwnerWxOpenId;
	}

	/**
	 * @mbggenerated 买方微信user_id
	 */
	public String getBuyOwnerWxUserId() {
		return buyOwnerWxUserId;
	}

	/**
	 * @mbggenerated 买方微信user_id
	 */
	public void setBuyOwnerWxUserId(String buyOwnerWxUserId) {
		this.buyOwnerWxUserId = buyOwnerWxUserId;
	}

	/**
	 * @mbggenerated 买方微信open_id
	 */
	public String getBuyOwnerWxOpenId() {
		return buyOwnerWxOpenId;
	}

	/**
	 * @mbggenerated 买方微信open_id
	 */
	public void setBuyOwnerWxOpenId(String buyOwnerWxOpenId) {
		this.buyOwnerWxOpenId = buyOwnerWxOpenId;
	}

	/**
	 * @mbggenerated 签约类型 0=线下 1=线上
	 */
	 ...
	 * @mbggenerated
	 */
	public ErpFunDeal(Integer shardCityId, Integer dealId) {
		super(shardCityId);
		this.dealId = dealId;
	}

	public String getUpdateContent(ErpFunDeal other) {
		int count = 0;
		StringBuilder appendSb = new StringBuilder();

		count = appendChangeStr(count, contractNo, other.contractNo, "合同编号", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeDouble(count, entrustMoney, other.entrustMoney, "托管金额", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeStr(count, entrustBank, other.entrustBank, "托管银行", appendSb);
		if(count >= 2){return appendSb.toString();}

		count = appendChangeDouble(count, area, other.area, "产权面积", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeStr(count, buildName, other.buildName, "楼盘名称", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeStr(count, buyCallPhone, other.buyCallPhone, "客户联系电话", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeStr(count, sellCallPhone, other.sellCallPhone, "业主联系电话", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeStr(count, buyContactuser, other.buyContactuser, "客户联系人", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeStr(count, buyCustinfo, other.buyCustinfo, "客户资料", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeStr(count, buyCustomerPhone, other.buyCustomerPhone, "客户电话", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeStr(count, buyHezuoCompname, other.buyHezuoCompname, "客户合作公司", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeStr(count, buyIdCard, other.buyIdCard, "客户身份证", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeStr(count, goodsdetailed, other.goodsdetailed, "物品清单", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeDouble(count, commercialLoanMoney, other.commercialLoanMoney, "商业贷款金额", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeDouble(count, providentLoanMoney, other.providentLoanMoney, "公积金贷款金额", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeStr(count, buyMortgageType, other.buyMortgageType, "按揭方式", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeStr(count, buyOwnerName, other.buyOwnerName, "客户姓名", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeStr(count, sellContactuser, other.sellContactuser, "卖方联系人", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeDouble(count, buyPaymoney, other.buyPaymoney, "买方付佣", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeStr(count, paytypeId, other.paytypeId, "客户付款方式", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeStr(count, buyPriceMoney, other.buyPriceMoney, "自付金额", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeStr(count, completeDate, other.completeDate, "审核时间", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeStr(count, completeUser, other.completeUser, "审核人", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeStr(count, custPlate, other.custPlate, "客源成交时的盘别", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeStr(count, custUsername, other.custUsername, "客源所属经纪人", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeStr(count, dealAuditStatus, other.dealAuditStatus, "合同审核状态", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeStr(count, dealDeptId, other.dealDeptId, "主办人的门店", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeStr(count, dealStatus, other.dealStatus, "业绩分配状态", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeStr(count, dealUserId, other.dealUserId, "主办人", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeDate(count, dealVerifyTime, other.dealVerifyTime, "结算时间", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeDate(count, evidenceDate, other.evidenceDate, "取证日期", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeDate(count, commercialLoanDate, other.commercialLoanDate, "商业贷放款日期", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeDate(count, providentLoanDate, other.providentLoanDate, "公积金贷放款日期", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeDate(count, providentLenderDate, other.providentLenderDate, "公积金贷贷款日期", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeStr(count, providentLenderLimit, other.providentLenderLimit, "公积金贷贷款年限", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeStr(count, providentLenderBank, other.providentLenderBank, "公积金贷贷款银行", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeStr(count, executor, other.executor, "指定执行人", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeStr(count, categoryId, other.categoryId, "合同类别", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeDouble(count, gainMoney, other.gainMoney, "收到的佣金金额", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeDouble(count, transferNeedPerformance, other.transferNeedPerformance, "过户应收", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeDouble(count, transferRealPerformance, other.transferRealPerformance, "过户实收", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeDouble(count, secondhandNeedPerformance, other.secondhandNeedPerformance, "二手佣金应收", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeDouble(count, secondhandRealPerformance, other.secondhandRealPerformance, "	二手佣金实收", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeDouble(count, newhouseNeedPerformance, other.newhouseNeedPerformance, "新房佣金应收", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeDouble(count, newhouseRealPerformance, other.newhouseRealPerformance, "新房佣金实收", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeDouble(count, leaseNeedPerformance, other.leaseNeedPerformance, "租赁应收业绩", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeDouble(count, leaseRealPerformance, other.leaseRealPerformance, "租赁实收业绩", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeDouble(count, financeNeedPerformance, other.financeNeedPerformance, "金融应收业绩", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeDouble(count, financeRealPerformance, other.financeRealPerformance, "金融实收业绩", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeStr(count, haveLandcard, other.haveLandcard, "有无国土证号", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeStr(count, houseUsername, other.houseUsername, "房源所属经纪人", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeStr(count, custDeptname, other.custDeptname, "客源所属门店", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeStr(count, houseDeptname, other.houseDeptname, "房源所属门店", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeStr(count, landcardNo, other.landcardNo, "国土证号", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeStr(count, mangementTax, other.mangementTax, "增值税", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeStr(count, modelId, other.modelId, "流程名", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeDouble(count, otherPaymoney, other.otherPaymoney, "其他收入", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeStr(count, ownerNo, other.ownerNo, "权属号", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeStr(count, ownerStyle, other.ownerStyle, "权属", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeStr(count, ownerTax, other.ownerTax, "个税", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeStr(count, ownerType, other.ownerType, "权属类型", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeStr(count, processStatus, other.processStatus, "流程状态", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeDouble (count, realBuyPaymoney, other.realBuyPaymoney, "实际客户付佣", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeDouble (count, realOtherPaymoney, other.realOtherPaymoney, "实际其他收入", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeDouble (count, realPaymoney, other.realPaymoney, "实际分佣金额", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeDouble (count, realSellPaymoney, other.realSellPaymoney, "实际卖方付佣", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeStr(count, remark, other.remark, "备注", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeStr(count, rentCycle, other.rentCycle, "租金单位", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeDate(count, rentDate, other.rentDate, "起租时间", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeDouble(count, rentDealMoney, other.rentDealMoney, "成交租金", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeDouble(count, rentDepositPay, other.rentDepositPay, "押金支付", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeDouble(count, rentOtherMoney, other.rentOtherMoney, "其他费用", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeDate(count, rentOverDate, other.rentOverDate, "到期时间", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeDate(count, commercialLenderDate, other.commercialLenderDate, "商业贷贷款日期", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeStr(count, commercialLenderLimit, other.commercialLenderLimit, "商业贷贷款年限", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeStr(count, commercialLenderBank, other.commercialLenderBank, "商业贷贷款银行", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeStr(count, rentPayEarly, other.rentPayEarly, "付款时间", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeStr(count, rentPayMethod, other.rentPayMethod, "付款方式", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeStr(count, rentPaySpace, other.rentPaySpace, "付款间隔", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeStr(count, rentPriceUnit, other.rentPriceUnit, "租金单位", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeStr(count, runstepId, other.runstepId, "当前执行流程的子步骤", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeStr(count, salePriceUnit, other.salePriceUnit, "出售成交金额单位", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeStr(count, sellAddress, other.sellAddress, "产权地址", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeDouble(count, sellDealMoney, other.sellDealMoney, "出售成交金额", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeStr(count, sellIdCard, other.sellIdCard, "业主身份证号", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeStr(count, getSellIshaveLoan(), other.getSellIshaveLoan(), "卖方借贷", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeDouble(count, sellLoanMoney, other.sellLoanMoney, "贷款金额", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeStr(count, sellOwnerName, other.sellOwnerName, "业主姓名", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeDouble(count, sellPaymoney, other.sellPaymoney, "卖方付佣", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeStr(count, sellOwnerPhone, other.sellOwnerPhone, "业主电话", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeDouble(count, sellOwnerCommsion, other.sellOwnerCommsion, "业主付佣", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeDouble(count, buyCustomerCommsion, other.buyCustomerCommsion, "客户付佣", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeStr(count, sellReturnLoan, other.sellReturnLoan, "还贷方式", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeDate(count, signDate, other.signDate, "签约日期", appendSb);
		if(count >= 2){return appendSb.toString();}
		//RENT_CYCLE
		count = appendChangeStr(count, signManagerDeptId, other.signManagerDeptId, "签约主管门店", appendSb);
		if(count >= 2){return appendSb.toString();}

		count = appendChangeStr(count, signManagerId, other.signManagerId, "签约主管", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeStr(count, signUserDeptId, other.signUserDeptId, "签约人门店", appendSb);
		if(count >= 2){return appendSb.toString();}

		count = appendChangeStr(count, signUserId, other.signUserId, "签约人", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeStr(count, stepNo, other.stepNo, "步骤编号", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeStr(count, tax, other.tax, "税费支付", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeDate(count, timelimitdate, other.timelimitdate, "到期时间", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeStr(count, tradeRemarkExplain, other.tradeRemarkExplain, "合同条款", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeDate(count, transferDate, other.transferDate, "过户日期", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeStr(count, waterlightexpenses, other.waterlightexpenses, "水电抄表", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeStr(count, buyOwnerNameBak, other.buyOwnerNameBak, "客户共有人", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeStr(count, sellOwnerNameBak, other.sellOwnerNameBak, "业主共有人", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeStr(count, buyIdCardBak, other.buyIdCardBak, "客户共有人身份证", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeStr(count, sellIdCardBak, other.sellIdCardBak, "业主共有人身份证", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeStr(count, sellOwnerPhoneBak, other.sellOwnerPhoneBak, "业主共有人电话", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeStr(count, buyCustomerPhoneBak, other.buyCustomerPhoneBak, "客户共有人电话", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeDouble(count, totalNeedPerformance, other.totalNeedPerformance, "应收业绩", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeDouble(count, totalRealPerformance, other.totalRealPerformance, "实收业绩", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeDouble(count, buyIdCardBakType,other.buyIdCardBakType, "买方证件类型", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeDouble(count, sellIdCardBakType,other.sellIdCardBakType, "卖方证件类型", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeDouble(count, sellIdCardBakType, other.sellIdCardBakType, "卖方共有人证件类型", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeDouble(count, buyIdCardBakType, other.buyIdCardBakType, "买方共有人证件类型", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeDouble(count, sellerProxyIdcardType, other.sellerProxyIdcardType, "卖方代理人证件类型", appendSb);
		if(count >= 2){return appendSb.toString();}
		count = appendChangeDouble(count, buyerProxyIdcardType, other.buyerProxyIdcardType, "买方代理人证件类型", appendSb);
		if(count >= 2){return appendSb.toString();}
		return appendSb.toString();
	}

	// compareTo 是原始数据  source 是传入数据
	private int appendChangeStr(int appendCount, Object source, Object compareTo, String infoStr, StringBuilder appendSb) {
		if(null!=source){
			if(source.equals(compareTo)) {
				return appendCount;
			}
			if(null == compareTo && (null == source || "".equals(source.toString()))) {
				return appendCount;
			}
			if (null==compareTo || !source.equals(compareTo)){
				appendCount++;
				appendSb.append(infoStr);
				if(appendCount != 2){
					appendSb.append("、");
				}
			}
	...
	private int appendChangeDate(int appendCount, String source, String compareTo, String infoStr, StringBuilder appendSb) {
		if (null!=source) {
			if (null==compareTo || !DateTimeHelper.formatDateTimetoString(source,DateTimeHelper.FMT_yyyyMMdd).equals( DateTimeHelper.formatDateTimetoString(compareTo,DateTimeHelper.FMT_yyyyMMdd))) {
				appendCount++;
				appendSb.append(infoStr);
				if (appendCount != 2) {
					appendSb.append("、");
	...
	private int appendChangeDouble(int appendCount, BigDecimal source, BigDecimal compareTo, String infoStr, StringBuilder appendSb) {
		if (null!=source) {
			if (null==compareTo || Double.valueOf(source.doubleValue()).compareTo(Double.valueOf(compareTo.doubleValue()))!=0 ) {
				appendCount++;
				appendSb.append(infoStr);
				if (appendCount != 2) {
					appendSb.append("、");
	...
	private int appendChangeDouble(int appendCount, Integer source, Integer compareTo, String infoStr, StringBuilder appendSb) {
		if (null!=source) {
			if (null==compareTo || source.compareTo(compareTo)!=0 ) {
				appendCount++;
				appendSb.append(infoStr);
				if (appendCount != 2) {
					appendSb.append("、");
	...
	private int appendChangeDate(int appendCount, Date source, Date compareTo, String infoStr, StringBuilder appendSb) {
		if (null!=source) {
			if (null==compareTo || !DateTimeHelper.formatDateTimetoString(source,DateTimeHelper.FMT_yyyyMMdd).equals( DateTimeHelper.formatDateTimetoString(compareTo,DateTimeHelper.FMT_yyyyMMdd))) {
				appendCount++;
				appendSb.append(infoStr);
