...
public class ErpFunEarbestMoney extends ShardDb implements Serializable {
	 ...
	 * @mbggenerated
	 */
	@ApiModelProperty(value = "诚意金状态 0待审核,1审核通过")
	 ...
	 * @mbggenerated
	 */
	@ApiModelProperty(value = "操作类别：默认0,  1.转房源，2.代付，3.转拥，4.退款，5.作废，6.转定金")
	 ...
	 * @mbggenerated
	 */
	public ErpFunEarbestMoney() {
	}

	/**
	 * @mbggenerated
	 */
	public ErpFunEarbestMoney(Integer shardCityId, Integer earbestId) {
		super(shardCityId);
		this.earbestId = earbestId;
	}
}