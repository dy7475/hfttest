...
public class ErpFunSaleTemplate extends ShardDb {
    /**
     *
     * @mbggenerated
     */
     ...
     * @mbggenerated
     */
    public void setSaleLadder(Byte saleLadder) {
     ...
     * @mbggenerated
     */
    public void setSaleFloors(Byte saleFloors) {
     ...
     * @mbggenerated
     */
    public void setSaleAccount(Byte saleAccount) {
     ...
     * @mbggenerated
     */
    public ErpFunSaleTemplate(Integer shardCityId) {
        super(shardCityId);
    }
}