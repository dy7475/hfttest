...
public class ErpFunHouseFile extends ShardDb implements Serializable {
	 ...
	 * @mbggenerated
	 */
	@ApiModelProperty(value = "文件类别DD:HOUSE_FILE")
	 ...
	 * @mbggenerated
	 */
	@ApiModelProperty(value = "文件类型DD:HOUSE_FILE")
	...
	/**
	 * @mbggenerated 文件类别DD:HOUSE_FILE
	 */
	...
	/**
	 * @mbggenerated 文件类型DD:HOUSE_FILE
	 */
	 ...
	 * @mbggenerated
	 */
	public ErpFunHouseFile() {
	}

	/**
	 * @mbggenerated
	 */
	public ErpFunHouseFile(Integer shardCityId, Integer id) {
		super(shardCityId);
		this.id = id;
	}
}