...
public class ErpFunSaleBakData extends ShardDb implements Serializable {
    /**
     *
     * @mbggenerated
     */
     ...
     * @mbggenerated
     */
    public ErpFunSaleBakData(Integer shardCityId, Integer saleId) {
        super(shardCityId);
        this.saleId = saleId;
    }
}