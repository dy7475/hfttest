...
public class ErpFunLeaseDto extends ErpFunLease{
	...
	private String saleBuildId;// 出售信息的BUILD_ID
	private byte saleUseage;// 出售信息的SALE_USEAGE
	private Integer saleId;// 出售信息的SALE_ID
	private byte saleStatus;// 出售信息的   房屋状态，DD：HOUSE_STATUS
	private BigDecimal saleUnitPrice;// 出售信息的   单价
	private BigDecimal saleTotalPrice;// 出售信息的   售价

	// 有效房源状态
	private Integer counts;//总共有效房源
	private Integer keyCount;//有效钥匙
	private Integer explrthCount;//已房勘
	private Integer publishCount;//已发布
	private Integer trueCount;//真房源
	private Integer photoCount;//有图片
	private Integer voidoCount;//有视频
	private Integer panoramaCount;//有VR
	private Integer scheduleCount;//预定
	...
	public String getSaleBuildId() {
		return saleBuildId;
	}
	
	public void setSaleBuildId(String saleBuildId) {
		this.saleBuildId = saleBuildId;
	}
