...
@ApiModel
public class QueryDepositListParam extends AbstractEncryParam {
	...
	@ApiModelProperty(value = "类型0=收定金1=转房源2=代付3=转拥4=退款 5=作废 多个逗号隔开")
	...
	@ApiModelProperty(value = "时间类型 AUDIT_TIME 审核时间 CREATE_TIME 创建时间 UPDATE_TIME 更新时间")
