...
public class DepositVO {
	...
	@ApiModelProperty(value = "定金状态：0.未审核，1.已审核，2.已作废")
	private Byte depositStatus;
	
	@ApiModelProperty(value = "定金备注")
	private String depositRemark;

	@ApiModelProperty(value = "操作类别：1.转房源，2.业主代付，3.转拥，4.退款")
