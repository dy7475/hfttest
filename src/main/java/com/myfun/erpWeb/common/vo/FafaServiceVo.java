...
@ApiModel
public class FafaServiceVo {
	@ApiModelProperty("发发URL信息")
	private String fafaServiceRoot;
	@ApiModelProperty("C++发发任务分发URL信息")
	private String fafaTaskServiceRoot;
	@ApiModelProperty("发发服务器URL信息")
	private String fafaWebServiceRoot;
	@ApiModelProperty("发发URL信息")
	private String fafaSiteIconPath;
	@ApiModelProperty("手动发布的路径")
	private String fafaWebkitUrlConfig;
	@ApiModelProperty("代发服务时的状态更新间隔发送请求的时间。单位：秒。例子：6秒钟请求一次服务器")
