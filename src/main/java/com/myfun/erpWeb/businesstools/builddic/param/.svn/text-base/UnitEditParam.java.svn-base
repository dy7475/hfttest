 ...
 * @since 2019/3/26
 */
public class UnitEditParam implements EncryParamIfc {
    ...
    @ApiModelProperty(value = "是否只修改了名称,没有修改规则(0=否 1=是)")
    private Byte onlyUpdateBase;
    ...
    public Byte getOnlyUpdateBase() {
        return onlyUpdateBase;
    }

    public void setOnlyUpdateBase(Byte onlyUpdateBase) {
        this.onlyUpdateBase = onlyUpdateBase;
    }
