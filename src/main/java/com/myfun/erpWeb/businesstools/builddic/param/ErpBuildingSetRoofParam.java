 ...
 * @since 2018/12/11
 */
public class ErpBuildingSetRoofParam implements EncryParamIfc {

    @ApiModelProperty(value = "表主键(栋ID)")
    ...
    @ApiModelProperty(value = "组成规则 1=户号，2=楼层+户号")
    private Byte compriseRule;

    @ApiModelProperty(value = "通排")
    private Byte addedByAllUnits;

    @ApiModelProperty(value = "排号规则 1=按楼层排号，2=按单元排号")
    private Byte numberRule;

    @ApiModelProperty(value = "数字，字母")
    private Byte numberType;

    @ApiModelProperty(value = "单元别名")
    private String buildUnitName;

    @ApiModelProperty(value = "该栋所包含的房间是否已经创建完毕(1完毕)")
