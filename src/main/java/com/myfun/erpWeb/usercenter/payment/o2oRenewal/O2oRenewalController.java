 ...
 */
@Controller
@RequestMapping(value = "/usercenter/payment/o2oRenewal")
public class O2oRenewalController extends BaseController{
	private static final Logger logger = LoggerFactory.getLogger(O2oRenewalController.class);
	...
	public ModelAndView index(HttpServletRequest request, ModelAndView view) {
		...
		view.setViewName("ucenter/o2oRenewal/index");
		return view;
	}
